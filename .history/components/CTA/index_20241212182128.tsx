        ...
        <div className="mx-auto max-w-c-1390 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] px-7.5 py-12.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark md:px-12.5 xl:px-17.5 xl:py-0">
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              ...
              <p>
              Maximize every minute of your time at the KITA Conference with our dedicated event app. Our Networking App is your personal gateway to connecting with the right people. With the app, you can:
              <p></p>
  • See what's happening at what time
  • Join curated discussions and meetups aligned with your interests
            ...
            >
              <div className="flex items-center justify-end xl:justify-between">
                <Image
                  width={299}
                  height={299}
                  src="/images/shape/iphone-mockup.png"
                  alt="Saly"
