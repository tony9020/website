...
<div className="mt-7.5 flex items-center gap-5 w-1/2">
  ...
  Book Your Room at Jumeirah Messilah Hotel
</h4>
<h2 className="relative mb-6 text-3xl font-bold text-black dark:text-white xl:text-hero">
  Experience Luxury in Kuwait City
</h2>

<p>
  Located in Kuwait City, Jumeirah Messilah Beach Hotel & Spa offers luxurious accommodations and exceptional service. As the host venue for the Kuwait International Treatment Abroad (KITA) Conference & Inhealth Exhibition, we invite you to experience our world-class facilities and amenities.
</p>
